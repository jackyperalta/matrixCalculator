...
btn_outToA = TkButton.new(root) {
    ...
    cursor 'hand2'
    activebackground 'blue'
    command {btn_outToA_click}
}
btn_outToB = TkButton.new(root) {
    borderwidth 5
    relief 'groove'
    text 'to B'
    state 'normal'
...
$label_MatrixA = TkLabel.new(root) {width 10; height 1; textvariable; borderwidth 0; relief 'groove'}
$label_MatrixB = TkLabel.new(root) {width 10; height 1; textvariable; borderwidth 0; relief 'groove'}
...
$label_MatrixA.place('height' => 25, 'width' => 220, 'x' => 150, 'y' => 40)
...
$label_MatrixB.place('height' => 25, 'width' => 220, 'x' => 640, 'y' => 40)
$text_MatrixB.place('x' => 510, 'y' => 70)
$text_MatrixOut.place('x' => 20, 'y' => 350)
label_Output.place('x' => 20, 'y' => 325)
btn_outToA.place('x' => 100, 'y' => 320)
btn_outToB.place('x' => 140, 'y' => 320)
